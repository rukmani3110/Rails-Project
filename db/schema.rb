...
ActiveRecord::Schema.define(version: 2020_04_16_093834) do
  ...
  create_table "projects", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "category_categoryId"
  end

  create_table "projs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "name"
    t.integer "user_id"
    t.integer "type_id"
    t.datetime "created_at", precision: 6, null: false
